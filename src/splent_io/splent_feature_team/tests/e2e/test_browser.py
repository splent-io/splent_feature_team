"""
End-to-end tests for splent_feature_team.
...
Run with:  splent feature:test splent_feature_team --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_team")
    assert "splent_feature_team" in browser.page_source.lower()
